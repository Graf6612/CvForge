              ...
              <>
                <div className="flex items-center gap-3 px-4 py-2 rounded-2xl bg-slate-50 border border-slate-200 shadow-sm">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm font-medium text-slate-600 max-w-[120px] truncate hidden md:block">
                      {user.email}
                    </span>
                  </div>
                </div>
                <Button 
                  ...
                  variant="ghost" 
                  size="icon" 
                  className="text-slate-400 hover:text-red-500 hover:bg-red-50 transition-colors w-10 h-10 sm:w-auto sm:h-9 sm:px-3 sm:py-2"
                  title="Вийти"
                >
